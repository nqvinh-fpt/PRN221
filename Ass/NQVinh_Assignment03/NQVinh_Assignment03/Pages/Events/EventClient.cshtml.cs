...
using NQVinh_Assignment03.Pages.Events.EventViewModels;
using NQVinh_Assignment03.Pages.Requirement1;
using Vinh.Hubs;
using WebApplication1.Models;
using static NQVinh_Assignment03.Pages.Requirement1.EventModel;
...
namespace NQVinh_Assignment03.Pages.Events
{
    public class EventClientModel : PageModel
    {
        ...
        public EventClientModel(PRN_Ass3Context context, IHubContext<SignalRServer> signalRHub)
        {
            _context = context;
